...
_Generated: 2026-06-02T05:38:16.180Z_
...
Workspace `mcp.json` _(folder: Mahfooj-portfolio)_

- **d:\Mahfooj\Mahfooj-portfolio\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\91786\.claude.json** — _File missing_
